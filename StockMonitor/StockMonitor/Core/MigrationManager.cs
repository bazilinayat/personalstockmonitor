...
namespace StockMonitor.Core
{
    ...
    public class MigrationManager
    {
        ...
        /// <summary>
        /// To represent the information of the table
        /// </summary>
        private class TableInfo
        {
            ...
            /// <summary>
            /// To know if the column allows null
            /// </summary>
            public int NotNull { get; set; }
            /// <summary>
            /// To know the column default value
            /// </summary>
            public string DefaultValue { get; set; }
            /// <summary>
            /// To know the primary key
            /// </summary>
            public int Pk { get; set; }
        }

        /// <summary>
        /// To store each column information
        /// </summary>
        public class ColumnInfo
        {
            ...
            public string Type { get; set; }
            /// <summary>
            /// To know if column allows null
            /// </summary>
            public bool NotNull { get; set; }
            /// <summary>
            /// To know if column is primary key
            /// </summary>
